...
static void	set_soul_sprites(t_spr **spr, t_img *img)
{
	...
	set_vec2(&spr[2]->pos, 10.0, 12.5);
	set_vec2(&spr[3]->pos, 3.5, 6.5);
	set_vec2(&spr[4]->pos, 3.5, 20.5);
	set_vec2(&spr[5]->pos, 3.5, 14.5);
	set_vec2(&spr[6]->pos, 14.5, 20.5);
...
static void	set_pillar_sprites(t_spr **spr, t_img *img)
{
	...
	set_vec2(&spr[8]->pos, 18.5, 11.5);
	set_vec2(&spr[9]->pos, 18.5, 12.5);
	set_vec2(&spr[10]->pos, 8.5, 7.0);
	return ;
}
...
static void	set_barrel_sprites(t_spr **spr, t_img *img)
{
	...
	set_vec2(&spr[12]->pos, 15.5, 1.5);
	set_vec2(&spr[13]->pos, 16.0, 1.8);
	set_vec2(&spr[14]->pos, 16.2, 1.2);
	set_vec2(&spr[15]->pos, 3.5, 2.5);
	set_vec2(&spr[16]->pos, 9.5, 15.5);
	set_vec2(&spr[17]->pos, 10.0, 15.1);
	set_vec2(&spr[18]->pos, 10.5, 15.8);
	return ;
}
