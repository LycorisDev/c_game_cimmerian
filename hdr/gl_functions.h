...
typedef GLint  (*GL_GUL)(GLuint program, GLchar* name);
typedef void   (*GL_GVAI)(GLuint index, GLenum pname, GLuint* params);
typedef void   (*GL_LP)(GLuint program);
typedef void   (*GL_SS)(GLuint shader, GLsizei count, GLchar** string, 
                        GLint* length);
