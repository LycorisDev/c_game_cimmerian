...
static int	mlx_int_param_undef(void);
...
static int	mlx_int_param_ButtonPress(t_xvar *xvar, XEvent *ev,
				t_win_list *win);
static int	mlx_int_param_ButtonRelease(t_xvar *xvar, XEvent *ev,
				t_win_list *win);
static int	mlx_int_param_MotionNotify(t_xvar *xvar, XEvent *ev,
				t_win_list *win);
