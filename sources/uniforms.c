...
static Uniform* create_uniform(const GLuint id_shader_program, const char* name, 
    const int activate_on_create, const ActivateUniformFunction activate, ...);
...
static void free_uniform(Uniform** u);

static void activate_uniform_float(const Uniform* u, const int activate);
static void activate_uniform_int(const Uniform* u, const int activate);
static void activate_uniform_uint(const Uniform* u, const int activate);

static void activate_uniform_vec2(const Uniform* u, const int activate);
static void activate_uniform_vec3(const Uniform* u, const int activate);
static void activate_uniform_vec4(const Uniform* u, const int activate);

static void activate_uniform_ivec2(const Uniform* u, const int activate);
static void activate_uniform_ivec3(const Uniform* u, const int activate);
static void activate_uniform_ivec4(const Uniform* u, const int activate);

static void activate_uniform_uvec2(const Uniform* u, const int activate);
static void activate_uniform_uvec3(const Uniform* u, const int activate);
static void activate_uniform_uvec4(const Uniform* u, const int activate);

static void activate_uniform_mat2(const Uniform* u, const int activate);
static void activate_uniform_mat3(const Uniform* u, const int activate);
static void activate_uniform_mat4(const Uniform* u, const int activate);

void create_uniforms(void)
{
    UNIFORM_FRAME_TEXTURE = create_uniform(shader_program_default->id, 
        "frame_texture", 1, activate_uniform_int, 0);
    ...
    const int activate_on_create, const ActivateUniformFunction activate, ...)
{
    ...
    */
    ...
    u->activate_on_create = activate_on_create;
    u->activate = activate;
    u->data = 0;
